    ...
    >
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center gap-10">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            A passionate Full Stack Developer specializing in React, Next.js,
            and the MERN stack, based in Dhaka, Bangladesh 📍. Dedicated to
            building scalable and efficient web applications with a focus on
